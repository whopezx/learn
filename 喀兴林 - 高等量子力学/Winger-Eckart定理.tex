...
首先考虑$m=j$的特殊情况，用总自旋角动量z方向投影的升算符$J_+$作用在$|j_1 j_2 j m\rangle$，即
\begin{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        &= \sum_{m'_1 m'_2}\sum_{m_1 m_2}\langle j_1 m'_1 j_2 m'_2|j_1 m_1 j_2 m_2\rangle
